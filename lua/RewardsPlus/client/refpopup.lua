if CLIENT then
    ...
    net.Receive("Rewards.openRef", function(len)
        ...
        popupFrame:SetSize(Rewards.AdapteResolution(400, 180))
        ...
        closeButton:SetPos(Rewards.AdapteResolution(370, 5))
        ...
        instructionLabel:SetPos(Rewards.AdapteResolution(50, 40))
        instructionLabel:SetSize(Rewards.AdapteResolution(300, 20))
        ...
        refCodeEntry:SetPos(Rewards.AdapteResolution(50, 70))
        refCodeEntry:SetSize(Rewards.AdapteResolution(300, 30))
        ...
        okButton:SetPos(Rewards.AdapteResolution(150, 120))
        okButton:SetSize(Rewards.AdapteResolution(100, 30))
        okButton:SetText("OK")
        ...
        okButton.DoClick = function()
            ...
            if refCode == "" then
                chat.AddText(colRed, Rewards.getTranslation("refPopUpText3"))
                return
            end
