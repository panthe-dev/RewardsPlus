...
function Rewards.getActiveTabIndex(propertySheet)
...
function Rewards.AdapteResolution(value, value2)
...
function Rewards.AdapteFontSize(fontSize)
...
surface.CreateFont("Trebuchet18_Adaptive", {
    font = "Trebuchet MS",
    size = Rewards.AdapteFontSize(18),
    weight = 500,
    antialias = true,
})
...
surface.CreateFont("Trebuchet24_Adaptive", {
    font = "Trebuchet MS",
    size = Rewards.AdapteFontSize(24),
    weight = 500,
    antialias = true,
})
...
surface.CreateFont("Trebuchet30_Adaptive", {
    font = "Trebuchet MS",
    size = Rewards.AdapteFontSize(30),
    weight = 800,
    antialias = true,
})
...
surface.CreateFont("DermaDefaultBold_Adaptive", {
    ...
    size = Rewards.AdapteFontSize(15),
    weight = 800,
    antialias = true,
})
...
surface.CreateFont("DermaDefault_Adaptive", {
    font = "DermaDefault",
    size = Rewards.AdapteFontSize(14),
    weight = 500,
    antialias = true,
})
